...
import { dataEngineeringRoadmap } from "@/data/dataEngineeringRoadmap";
import { FlowRoadmapMap } from "@/components/roadmap/FlowRoadmapMap";
import { Button } from "@/components/ui/button";

export default function DataEngineeringFlowPage() {
  return (
    <AppShell>
      ...
      <div className="mb-6">
        ...
        <h1 className="text-3xl font-bold tracking-tight text-foreground sm:text-4xl">Data Engineering Roadmap</h1>
      ...
      <FlowRoadmapMap data={dataEngineeringRoadmap} />
    </AppShell>
  );
}
